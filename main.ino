...
// 0x70.
static const u1_t PROGMEM APPEUI[8] = { 0x60, 0x0E, 0x01, 0xD0, 0x7E, 0xD5, 0xB3, 0x70 }; // Chose LSB mode on the console and then copy it here.
...
static const u1_t PROGMEM DEVEUI[8] = { 0x1F, 0x2B, 0x40, 0xC5, 0xAB, 0x2C, 0x89, 0x00 }; // LSB mode
...
static const u1_t PROGMEM APPKEY[16] = { 0x7E, 0xA9, 0xEC, 0xF0, 0x1F, 0x7A, 0xEF, 0x43, 0x6D, 0x4C, 0x75, 0x14, 0xC6, 0x20, 0xA7, 0xAB }; // MSB mode
